...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  ...
  const icons: { [key: string]: React.ReactElement } = {
    ...
    cow: <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.75l-7.5-7.5-7.5 7.5" /><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12.75v6.75a2.25 2.25 0 01-2.25 2.25H6.75a2.25 2.25 0 01-2.25-2.25v-6.75" />,
